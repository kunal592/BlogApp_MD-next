    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-neutral-950">
      <div className="max-w-md w-full bg-white dark:bg-neutral-900 shadow-md rounded-lg px-8 py-10">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">Or subscribe to our newsletter</p>
          <form className="mt-4 flex max-w-sm mx-auto">
            <input type="email" id="newsletter-email-address" autoComplete="email" required className="w-full px-4 py-2 min-w-0 text-base text-gray-900 bg-white border border-gray-300 rounded-md shadow-sm appearance-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="Enter your email" name="newsletter-email-address" />
            <button type="submit" className="ml-4 flex-shrink-0 px-4 py-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Subscribe</button>
          </form>
        </div>
      </div>
    </div>
